...
function convertMeetupToTwitch(meetup) {
  var meetupList = meetup.map(function (event) {
    ...
    var startDate = new Date(event.time + event.utc_offset).toISOString();
    ...
    return {
      ...
      url: event.link,
      start_date: startDate.replace(".000Z", event.utc_offset / 3600000),
      title: event.name
    };
  });
  return meetupList;
...
//# sourceMappingURL=index.js.5541a6af0626a5f5278c.hot-update.js.map