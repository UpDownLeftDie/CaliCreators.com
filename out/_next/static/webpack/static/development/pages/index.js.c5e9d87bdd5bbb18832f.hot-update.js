...
var Home = function Home() {
  ...
  var renderCards = function renderCards() {
    ...
    var nextEvents = groups.map(function (group) {
      ...
      console.log("".concat(a.start_date, " (").concat(new Date(a.start_date), ")  vs  ").concat(b.start_date, " (").concat(new Date(b.start_date), "))"));
...
//# sourceMappingURL=index.js.c5e9d87bdd5bbb18832f.hot-update.js.map