...
function convertMeetupToTwitch(meetup) {
  var meetupList = meetup.map(function (event) {
    ...
    return {
      ...
      url: event.link,
      start_date: new Date(event.time + event.utc_offset).toISOString.replace(".000Z", event.utc_offset / 3600000),
      title: event.name
    };
  });
  return meetupList;
...
//# sourceMappingURL=index.js.52a4f9d01de99a2085c4.hot-update.js.map