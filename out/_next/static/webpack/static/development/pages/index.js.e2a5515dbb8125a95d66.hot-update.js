...
function convertMeetupToTwitch(meetup) {
  var meetupList = meetup.map(function (event) {
    ...
    var startDate = new Date(event.time + event.utc_offset).toISOString().replace(".000Z", event.utc_offset / 3600000);
...
//# sourceMappingURL=index.js.e2a5515dbb8125a95d66.hot-update.js.map