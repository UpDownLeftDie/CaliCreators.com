...
var Home = function Home() {
  ...
  var renderCards = function renderCards() {
    ...
    var nextEvents = groups.map(function (group) {
      ...
      console.log("".concat(a.start_date, " (").concat(new Date(a.start_date), ")  vs  ").concat(b.start_date, " (").concat(new Date(b.start_date), ") = ").concat(new Date(a.start_date) - new Date(b.start_date)));
...
//# sourceMappingURL=index.js.e130d67d4feaa92767cb.hot-update.js.map